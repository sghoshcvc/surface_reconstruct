...
int main()
{
        ...
        const std::string input_file("data/tile.pwn");
  ...
  // 0.9 < dot(surface_normal, point_normal);
        ...
        const std::string& output_file("data/tile_result.off");
        ...
        const std::string& candidate_faces_file("data/tile_candidate_faces.off");
